...
const MODEL_CATALOG: ModelEntry[] = [
  ...
  { id: "openai/gpt-5.5", name: "GPT-5.5", provider: "openai", providerLabel: "OpenAI", channel: "vercel", contextWindow: 1000000, pricing: { prompt: 0.000005, completion: 0.00003 }, features: ["vision", "function-calling"], description: "GPT-5.5 新一代旗舰" },
  ...
  { id: "meta/muse-spark-1.3-contributor", name: "Muse Spark 1.3 Contributor", provider: "meta", providerLabel: "Meta", channel: "vercel", contextWindow: 1000000, pricing: { prompt: 0.0000001, completion: 0.0000002 }, features: ["function-calling", "reasoning", "long-context"], description: "Muse Spark 1.3 贡献者版" },
  { id: "meta/muse-spark-1.3", name: "Muse Spark 1.3", provider: "meta", providerLabel: "Meta", channel: "vercel", contextWindow: 1000000, pricing: { prompt: 0.00000125, completion: 0.00000425 }, features: ["function-calling", "reasoning", "long-context"], description: "Muse Spark 1.3 旗舰" },
  ...
  { id: "minimax/minimax-m3", name: "MiniMax M3", provider: "minimax", providerLabel: "MiniMax", channel: "vercel", contextWindow: 1000000, pricing: { prompt: 0.0000003, completion: 0.0000012 }, features: ["function-calling", "long-context"], description: "MiniMax M3 旗舰" },

  // ── StepFun ───────────────────────────────────────────────
  { id: "stepfun/step-3.7-flash", name: "Step 3.7 Flash", provider: "stepfun", providerLabel: "StepFun", channel: "vercel", contextWindow: 262144, pricing: { prompt: 0.0000002, completion: 0.00000115 }, features: ["function-calling"], description: "StepFun 快速推理版" },
  ...
  { id: "nvidia/nemotron-3-ultra-50b-a55b", name: "Nemotron 3 Ultra 50B", provider: "nvidia", providerLabel: "NVIDIA", channel: "vercel", contextWindow: 1000000, pricing: { prompt: 0.00000037, completion: 0.00000108 }, features: ["function-calling", "reasoning", "long-context"], description: "NVIDIA 超大长上下文旗舰" },
